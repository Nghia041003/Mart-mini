  ...
  return (
    <div className='bg-white'>
      ...
      <div className='grid grid-cols-5 gap-10'>
        <Link className='w-full block' to='product'>
          <div className='bg-yellow-500 rounded-lg pt-4 mb-6 block  h-[150px]'>
            <div className='block  px-6'>
              {<div className='text-5xl text-white font-semibold pb-[22px]'>{totalProducts}</div>}
              <div className='text-white font-medium text-base mb-6'>Sản Phẩm</div>
            </div>
          </div>
        </Link>
        <Link className='w-full block' to='category'>
          <div className='bg-green-500 rounded-lg pt-6 mb-8 block h-[150px]'>
            <div className='block px-6'>
              {<div className='text-5xl text-white font-semibold pb-[22px]'>{categoryData?.data.length}</div>}
              <div className='text-white font-medium text-base mb-9'>Danh Mục Sản Phẩm</div>
            </div>
          </div>
        </Link>
        <Link className='w-full block' to='tintuc'>
          <div className='bg-orange-500 rounded-lg pt-6 mb-8 block h-[150px]'>
            <div className='block px-6'>
              {<div className='text-5xl text-white font-semibold pb-[22px]'> {tintucData?.length} </div>}
              <div className='text-white font-medium text-base mb-9'>Tin Tức</div>
            </div>
          </div>
        </Link>
        <div className='bg-rose-500 rounded-lg pt-6 mb-8 block h-[150px]' onClick={() => setIsModalOpen(true)}>
          <div className='block px-6'>
            {
            ...
            <div className='text-white font-medium text-base mb-9'>Đơn Hàng Chưa Xử Lý</div>
          </div>
        </div>
      </div>
      {/* <div className='grid grid-cols-2 mt-10'>
        <Link to='contact'>
          <div className='bg-purple-500 !hidden rounded-lg pt-6 mb-8 w-[300px] h-[150px]'>
            <div className='block px-6'>
