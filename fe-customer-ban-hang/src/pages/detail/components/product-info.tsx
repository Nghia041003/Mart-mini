...
export const ProductInfo = ({ productInfo }: ProductInfoProps) => {
  ...
  const [sizeSelected] = useState<IListQuantityRemain | null>(productInfo.listQuantityRemain[0])
  ...
  const increaseQuantity = () => {
    ...
    if (quantiry >= productInfo.quantity) {
  ...
  return (
    <div className='flex flex-col gap-5 select-none'>
      ...
      <p className=''>Số lượng: {productInfo.quantity}</p>
